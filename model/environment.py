...
class Environment:
    ...
    def charge_minutes_needed(self, battery_level: int, target_battery_level: int) -> int:
        kwh_needed = (target_battery_level - battery_level) / 100 * self.battery_capacity_kwh
